...
if((cljs.core.peek(index) < ((function (){var G__46510 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46510) : instaparse.auto_flatten_seq.true_count.call(null,G__46510));
})() - (1)))){
...
while(true){
if((!((coll__$1 == null)))){
var G__46584 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__46585 = cljs.core.next(coll__$1);
unmixed_hash = G__46584;
coll__$1 = G__46585;
continue;
} else {
return unmixed_hash;
...
var G__46586 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__46587 = cljs.core.next(v);
acc = G__46586;
v = G__46587;
continue;
} else {
var G__46588 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__46589 = cljs.core.next(v);
acc = G__46588;
v = G__46589;
continue;
}
