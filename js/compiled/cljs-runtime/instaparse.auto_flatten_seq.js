...
if((cljs.core.peek(index) < ((function (){var G__46502 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__46502) : instaparse.auto_flatten_seq.true_count.call(null,G__46502));
})() - (1)))){
