...
var G__46587 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__46588 = cljs.core.next(v);
acc = G__46587;
v = G__46588;
continue;
} else {
var G__46590 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46592 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_46592(self);
}
});
