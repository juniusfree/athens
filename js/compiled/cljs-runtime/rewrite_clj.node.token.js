...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k29601,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29601,else__4383__auto__);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29602,other29603){
var self__ = this;
var this29602__$1 = this;
return (((!((other29603 == null)))) && ((this29602__$1.constructor === other29603.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29602__$1.value,other29603.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29602__$1.string_value,other29603.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29602__$1.__extmap,other29603.__extmap)));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__29600){
var self__ = this;
...
return (new rewrite_clj.node.token.TokenNode(G__29600,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
...
return (new rewrite_clj.node.token.TokenNode(self__.value,G__29600,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__29600),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__29600){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__29600,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__29604){
var extmap__4419__auto__ = (function (){var G__29614 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__29604,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__29604)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29614);
} else {
return G__29614;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__29604),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__29604),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
