...
})(),(function (){var G__35634 = cljs.core.vec(cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),item));
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2((function (){var G__35636 = cljs.core.vec(cljs.core.rest(where));
...
})(),(function (){var G__35637 = cljs.core.vec(cljs.core.rest(item));
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__35637) : posh.lib.q_analyze.get_eavs.call(null,G__35637));
})());
}
} else {
if(posh.lib.q_analyze.eav_QMARK_(item)){
return cljs.core.cons(item,(function (){var G__35638 = cljs.core.rest(where);
return (posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1 ? posh.lib.q_analyze.get_eavs.cljs$core$IFn$_invoke$arity$1(G__35638) : posh.lib.q_analyze.get_eavs.call(null,G__35638));
})());
} else {
...
var G__36064 = var$;
var G__36065 = dbvarmap;
var G__36066 = cljs.core.rest(dbeavs);
var$ = G__36064;
dbvarmap = G__36065;
dbeavs = G__36066;
continue;
...
var G__36067 = (n + (1));
var G__36068 = cljs.core.rest(xs__$1);
n = G__36067;
xs__$1 = G__36068;
continue;
...
var G__36075 = cljs.core.first(remaining);
var G__36076 = cljs.core.rest(remaining);
clause = G__36075;
remaining = G__36076;
continue;
} else {
...
if(cljs.core.seq(remaining)){
var G__36077 = cljs.core.first(remaining);
var G__36078 = cljs.core.rest(remaining);
clause = G__36077;
remaining = G__36078;
continue;
} else {
