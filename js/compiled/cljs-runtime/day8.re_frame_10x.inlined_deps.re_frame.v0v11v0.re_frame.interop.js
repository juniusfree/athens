...
return [(function (){var pred__26909 = cljs.core.instance_QMARK_;
var expr__26910 = reactive_val;
if(cljs.core.truth_((pred__26909.cljs$core$IFn$_invoke$arity$2 ? pred__26909.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__26910) : pred__26909.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__26910)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26909.cljs$core$IFn$_invoke$arity$2 ? pred__26909.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__26910) : pred__26909.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__26910)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26909.cljs$core$IFn$_invoke$arity$2 ? pred__26909.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__26910) : pred__26909.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__26910)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26909.cljs$core$IFn$_invoke$arity$2 ? pred__26909.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__26910) : pred__26909.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__26910)))){
return "tr";
} else {
return "other";
}
