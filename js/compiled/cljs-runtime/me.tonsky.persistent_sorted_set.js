...
var n__4613__auto___36389 = l__36220__auto___36388;
var i__36221__auto___36391 = (0);
while(true){
if((i__36221__auto___36391 < n__4613__auto___36389)){
(new_arr[(i__36221__auto___36391 + l1xs)] = (arr[(i__36221__auto___36391 + splice_to)]));

var G__36392 = (i__36221__auto___36391 + (1));
i__36221__auto___36391 = G__36392;
continue;
} else {
}
break;
...
while(true){
if((level > (0))){
var G__36465 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__36466 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__36465;
node = G__36466;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__36472 = (function (){var arr__36245__auto__ = node__$1.pointers;
return (arr__36245__auto__[(arr__36245__auto__.length - (1))]);
})();
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_36505 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_36505(this$,left,right);
}
});
...
var G__36516 = (left__$1 + (1));
var G__36517 = keys__$1;
var G__36518 = (idx__$1 + (1));
var G__36519 = new_acc;
left__$1 = G__36516;
keys__$1 = G__36517;
idx__$1 = G__36518;
acc = G__36519;
...
var G__36576 = (node.pointers[idx]);
var G__36577 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__36578 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__36576;
path = G__36577;
level = G__36578;
continue;
