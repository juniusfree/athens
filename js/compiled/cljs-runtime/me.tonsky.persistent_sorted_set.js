...
var G__36549 = (node.pointers[idx]);
var G__36550 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__36551 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__36549;
path = G__36550;
level = G__36551;
continue;
...
var G__36561 = (node.pointers[idx]);
var G__36562 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__36563 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__36561;
path = G__36562;
level = G__36563;
continue;
...
var pos_36579 = (0);
while(true){
var rest_36581 = (len - pos_36579);
if((rest_36581 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36579));
} else {
if((rest_36581 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36579,(pos_36579 + chunk_len)));

var G__36586 = (pos_36579 + chunk_len);
pos_36579 = G__36586;
continue;
} else {
var piece_len_36588 = (rest_36581 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_36579,(pos_36579 + piece_len_36588)));

var G__36590 = (pos_36579 + piece_len_36588);
pos_36579 = G__36590;
continue;
...
break;
default:
var G__36624 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__36359,leaves){
...
var G__36625 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__36624;
shift = G__36625;
continue;
