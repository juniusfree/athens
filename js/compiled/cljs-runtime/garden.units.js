...
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53767);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__53771__i < G__53771__a.length) {G__53771__a[G__53771__i] = arguments[G__53771__i + 2]; ++G__53771__i;}
  more = new cljs.core.IndexedSeq(G__53771__a,0,null);
} 
...
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__53774);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
