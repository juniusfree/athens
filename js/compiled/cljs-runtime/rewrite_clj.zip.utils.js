...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__29816,k,f){
var vec__29820 = p__29816;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29820,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29820,(1),null);
var loc = vec__29820;
...
var G__29862 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__29862;
continue;
} else {
return zloc__$1;
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__29836){
