...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__29819,k,f){
var vec__29821 = p__29819;
...
var G__29854 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__29854;
continue;
}
break;
...
var G__29855 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__29855;
continue;
} else {
return zloc__$1;
...
var G__29856 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__29856;
continue;
} else {
return zloc__$1;
...
var vec__29849 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29849,(0),null);
var map__29852 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29849,(1),null);
var map__29852__$1 = (((((!((map__29852 == null))))?(((((map__29852.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29852.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29852):map__29852);
var path = map__29852__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29852__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29852__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29852__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29852__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
