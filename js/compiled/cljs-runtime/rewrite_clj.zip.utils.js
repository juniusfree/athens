...
var G__29848 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__29848;
continue;
}
break;
...
var G__29849 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__29849;
continue;
} else {
return zloc__$1;
...
var G__29851 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__29851;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__29824){
var vec__29825 = p__29824;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29825,(0),null);
var map__29828 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29825,(1),null);
var map__29828__$1 = (((((!((map__29828 == null))))?(((((map__29828.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29828.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29828):map__29828);
var path = map__29828__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29828__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__29825;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__29832){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29836__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__29833;
if(cljs.core.seq(r)){
