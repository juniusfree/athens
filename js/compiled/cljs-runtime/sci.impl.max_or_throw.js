...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62620 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62620(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62610 = (n - (1));
var G__62611 = cljs.core.rest(s);
var G__62612 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62610,G__62611,G__62612) : sci.impl.max_or_throw.take_STAR_.call(null,G__62610,G__62611,G__62612));
})());
} else {
return null;
}
