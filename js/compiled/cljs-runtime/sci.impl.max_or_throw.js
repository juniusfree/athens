...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62604 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62604(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62588 = (n - (1));
var G__62589 = cljs.core.rest(s);
var G__62590 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62588,G__62589,G__62590) : sci.impl.max_or_throw.take_STAR_.call(null,G__62588,G__62589,G__62590));
})());
} else {
return null;
}
