...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62618 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62618(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62615 = (n - (1));
var G__62616 = cljs.core.rest(s);
var G__62617 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62615,G__62616,G__62617) : sci.impl.max_or_throw.take_STAR_.call(null,G__62615,G__62616,G__62617));
})());
} else {
return null;
}
