...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62632 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_62632(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__62625 = (n - (1));
var G__62626 = cljs.core.rest(s);
var G__62627 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__62625,G__62626,G__62627) : sci.impl.max_or_throw.take_STAR_.call(null,G__62625,G__62626,G__62627));
})());
} else {
return null;
}
