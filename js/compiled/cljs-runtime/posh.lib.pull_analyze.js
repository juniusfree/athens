...
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(ref_key.cljs$core$IFn$_invoke$arity$1 ? ref_key.cljs$core$IFn$_invoke$arity$1(affected_pull) : ref_key.call(null,affected_pull))], 0)):(function (){var G__34176 = schema;
var G__34177 = ref_pull;
var G__34178 = (ref_key.cljs$core$IFn$_invoke$arity$2 ? ref_key.cljs$core$IFn$_invoke$arity$2(affected_pull,refs_only_QMARK_) : ref_key.call(null,affected_pull,refs_only_QMARK_));
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3(G__34176,G__34177,G__34178) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,G__34176,G__34177,G__34178));
})()
)));
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__34187,pull_pattern,ent_id){
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__34194 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__34194.cljs$core$IFn$_invoke$arity$2 ? fexpr__34194.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__34194.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__34219,pull_pattern,ent_ids){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34221__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34221__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34221__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
return (fexpr__34227.cljs$core$IFn$_invoke$arity$2 ? fexpr__34227.cljs$core$IFn$_invoke$arity$2(db,p1__34210_SHARP_) : fexpr__34227.call(null,db,p1__34210_SHARP_));
}),ent_ids);
