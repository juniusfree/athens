...
var G__34157 = cljs.core.first(x);
var fexpr__34156 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"limit","limit",284709164,null),null,"limit",null], null), null);
return (fexpr__34156.cljs$core$IFn$_invoke$arity$1 ? fexpr__34156.cljs$core$IFn$_invoke$arity$1(G__34157) : fexpr__34156.call(null,G__34157));
} else {
return false;
}
});
...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__34160_SHARP_){
return ((cljs.core.map_QMARK_(p1__34160_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__34160_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__34162_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__34162_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__34162_SHARP_)));
}),entity_keys);
...
})())?cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__34166_SHARP_){
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$4(schema,ref_pull,p1__34166_SHARP_,refs_only_QMARK_) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__34166_SHARP_,refs_only_QMARK_));
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(ref_key.cljs$core$IFn$_invoke$arity$1 ? ref_key.cljs$core$IFn$_invoke$arity$1(affected_pull) : ref_key.call(null,affected_pull))], 0)):(function (){var G__34186 = schema;
var G__34187 = ref_pull;
var G__34188 = (ref_key.cljs$core$IFn$_invoke$arity$2 ? ref_key.cljs$core$IFn$_invoke$arity$2(affected_pull,refs_only_QMARK_) : ref_key.call(null,affected_pull,refs_only_QMARK_));
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3(G__34186,G__34187,G__34188) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,G__34186,G__34187,G__34188));
})()
)));
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__34201,pull_pattern,ent_id){
var map__34204 = p__34201;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34204__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34204__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34204__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__34209 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__34209.cljs$core$IFn$_invoke$arity$2 ? fexpr__34209.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__34209.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__34230,pull_pattern,ent_ids){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34232__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34232__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34232__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
