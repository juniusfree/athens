...
return handle_mode(p1__54393_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__54393_SHARP_));
...
return handle_mode(cljs.core.first(p1__54394_SHARP_),cljs.core.second(p1__54394_SHARP_));
}),modes);
} else {
return null;
}
