...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25133__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__25134 = u(y);
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25134__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
while (G__25266__i < G__25266__a.length) {G__25266__a[G__25266__i] = arguments[G__25266__i + 2]; ++G__25266__i;}
  more = new cljs.core.IndexedSeq(G__25266__a,0,null);
} 
...
var G__25269 = null;
if (arguments.length > 2) {
var G__25270__i = 0, G__25270__a = new Array(arguments.length -  2);
while (G__25270__i < G__25270__a.length) {G__25270__a[G__25270__i] = arguments[G__25270__i + 2]; ++G__25270__i;}
G__25269 = new cljs.core.IndexedSeq(G__25270__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25269);
}
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25282);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25293);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__25302);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
