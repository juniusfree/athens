...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20719__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20719__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20719__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20718){var _e = e20718;
return false;
}});
...
var seen_errors_20755 = temp__5733__auto___20752;
if(cljs.core.truth_(seen_errors_20755.has(self))){
} else {
seen_errors_20755.add(self);

var temp__5735__auto___20757 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20757)){
var sense_20758 = temp__5735__auto___20757;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20758)].join(''));
} else {
}
}
} else {
