...
var G__48344 = (i__4737__auto___48342 + (1));
i__4737__auto___48342 = G__48344;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48261){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48264 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48264) : instaparse.reduction.node_builders.call(null,G__48264));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48257){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48258,G__48259,seq48257__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___48353 = arguments.length;
var i__4737__auto___48354 = (0);
while(true){
if((i__4737__auto___48354 < len__4736__auto___48353)){
args__4742__auto__.push((arguments[i__4737__auto___48354]));

var G__48355 = (i__4737__auto___48354 + (1));
i__4737__auto___48354 = G__48355;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48271){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48277 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__48277) : instaparse.reduction.node_builders.call(null,G__48277));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48268){
var G__48269 = cljs.core.first(seq48268);
var seq48268__$1 = cljs.core.next(seq48268);
var G__48270 = cljs.core.first(seq48268__$1);
var seq48268__$2 = cljs.core.next(seq48268__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48269,G__48270,seq48268__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k48287,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48287,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__48299){
var vec__48301 = p__48299;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48301,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48289,other48290){
var self__ = this;
var this48289__$1 = this;
return (((!((other48290 == null)))) && ((this48289__$1.constructor === other48290.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48289__$1.grammar,other48290.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48289__$1.start_production,other48290.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48289__$1.output_format,other48290.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48289__$1.__extmap,other48290.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__48286){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__48319 = cljs.core.keyword_identical_QMARK_;
var expr__48320 = k__4388__auto__;
if(cljs.core.truth_((pred__48319.cljs$core$IFn$_invoke$arity$2 ? pred__48319.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48320) : pred__48319.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__48320)))){
return (new instaparse.core.Parser(G__48286,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48319.cljs$core$IFn$_invoke$arity$2 ? pred__48319.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48320) : pred__48319.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__48320)))){
return (new instaparse.core.Parser(self__.grammar,G__48286,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__48319.cljs$core$IFn$_invoke$arity$2 ? pred__48319.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48320) : pred__48319.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__48320)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__48286,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__48286),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__48286){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__48286,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args48296){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args48296)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__48292){
var extmap__4419__auto__ = (function (){var G__48327 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48292,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__48292)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48327);
} else {
return G__48327;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__48292),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__48292),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__48292),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
while(true){
if((i__4737__auto___48446 < len__4736__auto___48442)){
