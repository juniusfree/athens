...
if(cljs.core.truth_((function (){var fexpr__48282 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__48282.cljs$core$IFn$_invoke$arity$1 ? fexpr__48282.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48282.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__48285 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__48285.cljs$core$IFn$_invoke$arity$1 ? fexpr__48285.cljs$core$IFn$_invoke$arity$1(type) : fexpr__48285.call(null,type));
})())){
} else {
...
var G__48292 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__48292)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__48292)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__48292)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__48292)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48292)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__48304){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__48307 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq48297){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48298,G__48299,seq48297__$2);
}));
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq48308){
var G__48309 = cljs.core.first(seq48308);
var seq48308__$1 = cljs.core.next(seq48308);
var G__48310 = cljs.core.first(seq48308__$1);
var seq48308__$2 = cljs.core.next(seq48308__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48309,G__48310,seq48308__$2);
}));
...
var G__48416 = (i__4737__auto___48415 + (1));
i__4737__auto___48415 = G__48416;
continue;
} else {
}
break;
