...
var args__4742__auto__ = [];
var len__4736__auto___42544 = arguments.length;
var i__4737__auto___42545 = (0);
while(true){
if((i__4737__auto___42545 < len__4736__auto___42544)){
args__4742__auto__.push((arguments[i__4737__auto___42545]));

var G__42546 = (i__4737__auto___42545 + (1));
i__4737__auto___42545 = G__42546;
continue;
} else {
}
break;
...
var vec__42379 = s;
var initial = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42379,(0),null);
var subsequent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42379,(1),null);
...
var G__42436 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42436__$1)].join('')));
...
var G__42484 = tick.core.range((function (){var G__42485 = tick.core.beginning(ival);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(G__42484,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__42488 = tick.core.end(ival);
...
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__42490_SHARP_,dur),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,(function (p1__42492_SHARP_){
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__42492_SHARP_,period),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
...
break;
case "finished-by":
var vec__42515 = tick.interval.split_with_assert(ival,tick.core.beginning(group));
