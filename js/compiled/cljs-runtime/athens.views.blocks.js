...
return e.preventDefault();
})], null)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"position","position",-2011731912),"absolute",new cljs.core.Keyword(null,"left","left",-399115937),(left + (24)),new cljs.core.Keyword(null,"top","top",-1856271961),(top + (24))], null)], null)], 0)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#dropdown-menu","div#dropdown-menu",-1653601360),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.dropdown.menu_style),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"max-height","max-height",-612563804),"8em"], null)], null)], 0)),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4529__auto__ = (function athens$views$blocks$slash_menu_el_$_iter__61897(s__61898){
return (new cljs.core.LazySeq(null,(function (){
var s__61898__$1 = s__61898;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61898__$1);
if(temp__5735__auto__){
var s__61898__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61898__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__61898__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__61900 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__61899 = (0);
while(true){
if((i__61899 < size__4528__auto__)){
var vec__61901 = cljs.core._nth(c__4527__auto__,i__61899);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61901,(0),null);
var vec__61904 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61901,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61904,(0),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61904,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61904,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61904,(3),null);
var _pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61904,(4),null);
var item = vec__61904;
cljs.core.chunk_append(b__61900,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"id","id",-1388402092),["dropdown-item-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61899,vec__61901,i,vec__61904,text,icon,_expansion,kbd,_pos,item,c__4527__auto__,size__4528__auto__,b__61900,s__61898__$2,temp__5735__auto__,map__61893,map__61893__$1,caret_position,index,results,type,map__61894,map__61894__$1,left,top,ref,handle_click_outside){
return (function (_){
return athens.views.blocks.slash_item_click(state__$1,block,item);
});})(i__61899,vec__61901,i,vec__61904,text,icon,_expansion,kbd,_pos,item,c__4527__auto__,size__4528__auto__,b__61900,s__61898__$2,temp__5735__auto__,map__61893,map__61893__$1,caret_position,index,results,type,map__61894,map__61894__$1,left,top,ref,handle_click_outside))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61900),athens$views$blocks$slash_menu_el_$_iter__61897(cljs.core.chunk_rest(s__61898__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61900),null);
}
} else {
var vec__61907 = cljs.core.first(s__61898__$2);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61907,(0),null);
var vec__61910 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61907,(1),null);
var text = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61910,(0),null);
var icon = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61910,(1),null);
var _expansion = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61910,(2),null);
var kbd = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61910,(3),null);
var _pos = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61910,(4),null);
var item = vec__61910;
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),text,new cljs.core.Keyword(null,"id","id",-1388402092),["dropdown-item-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,index),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61907,i,vec__61910,text,icon,_expansion,kbd,_pos,item,s__61898__$2,temp__5735__auto__,map__61893,map__61893__$1,caret_position,index,results,type,map__61894,map__61894__$1,left,top,ref,handle_click_outside){
return (function (_){
return athens.views.blocks.slash_item_click(state__$1,block,item);
});})(vec__61907,i,vec__61910,text,icon,_expansion,kbd,_pos,item,s__61898__$2,temp__5735__auto__,map__61893,map__61893__$1,caret_position,index,results,type,map__61894,map__61894__$1,left,top,ref,handle_click_outside))
], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.core.adapt_react_class(icon)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),text], null),(cljs.core.truth_(kbd)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"kbd","kbd",316156875),kbd], null):null)], null)], null),athens$views$blocks$slash_menu_el_$_iter__61897(cljs.core.rest(s__61898__$2)));
}
} else {
return null;
}
...
var map__61913 = athens.keybindings.destruct_target(e.target);
...
var head = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61913__$1,new cljs.core.Keyword(null,"head","head",-771383919));
var tail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61913__$1,new cljs.core.Keyword(null,"tail","tail",-1146023564));
