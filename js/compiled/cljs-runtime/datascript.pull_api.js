...
var pattern_37937 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_37937,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var vec__37867 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37867,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37867,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37876__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37876__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__37878 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__37878,attr,eid);
} else {
return G__37878;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37883__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37883__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__37891){
while(true){
...
var frame = first__37894;
var frames = seq__37893__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__37942 = db;
var G__37943 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__37942;
p__37891 = G__37943;
continue;
}
...
while(true){
var G__37896 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__37896__$1 = (((G__37896 instanceof cljs.core.Keyword))?G__37896.fqn:null);
switch (G__37896__$1) {
case "expand":
var G__37945 = db;
var G__37946 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__37945;
frames = G__37946;
continue;
...
case "expand-rev":
var G__37947 = db;
var G__37948 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__37947;
frames = G__37948;
continue;
...
case "pattern":
var G__37950 = db;
var G__37951 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__37950;
frames = G__37951;
continue;
...
case "recursion":
var G__37952 = db;
var G__37953 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__37952;
frames = G__37953;
continue;
...
var f = first__37906;
var remaining = seq__37905__$1;
var result = (function (){var G__37907 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__37907);
} else {
return G__37907;
}
})();
...
var G__37958 = db;
var G__37959 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__37911 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__37911,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__37911;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__37896__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__37915_SHARP_){
return datascript.db.entid_strict(db,p1__37915_SHARP_);
})),eids);
