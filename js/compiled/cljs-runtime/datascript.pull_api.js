...
var pattern_37886 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_37886,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var rec = (function (){var G__37865 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__37865,attr,eid);
} else {
return G__37865;
}
})();
...
var G__37927 = db;
var G__37928 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__37927;
p__37871 = G__37928;
continue;
}
...
case "expand":
var G__37936 = db;
var G__37937 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__37936;
frames = G__37937;
continue;
...
case "expand-rev":
var G__37938 = db;
var G__37939 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__37938;
frames = G__37939;
continue;
...
case "pattern":
var G__37940 = db;
var G__37941 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__37940;
frames = G__37941;
continue;
...
case "recursion":
var G__37942 = db;
var G__37943 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__37942;
frames = G__37943;
continue;
...
var G__37947 = db;
var G__37948 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__37880 = cljs.core.first(remaining);
