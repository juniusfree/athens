...
return (o__20666__auto__["add"]).call(o__20666__auto__,value);
}
});
...
var o__20666__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20666__auto__["delete"]).call(o__20666__auto__,value);
}
});
...
var o__20666__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20666__auto__["has"]).call(o__20666__auto__,value);
}
});
...
var G__23809 = data;
var target__20681__auto__ = G__23809;
if(cljs.core.truth_(target__20681__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23809)].join(''),"\n","target__20681__auto__"].join('')));
}

(target__20681__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
...
(devtools.formatters.budgeting.distribute_budget_BANG_.cljs$core$IFn$_invoke$arity$2 ? devtools.formatters.budgeting.distribute_budget_BANG_.cljs$core$IFn$_invoke$arity$2(item_23843,new_depth_budget_23826) : devtools.formatters.budgeting.distribute_budget_BANG_.call(null,item_23843,new_depth_budget_23826));
...
var G__23846 = (0);
var G__23847 = (0);
seq__23813_23827 = G__23844;
chunk__23814_23828 = G__23845;
count__23815_23829 = G__23846;
i__23816_23830 = G__23847;
continue;
}
} else {
}
