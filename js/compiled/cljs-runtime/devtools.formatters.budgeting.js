...
var G__23797 = data;
var target__20638__auto__ = G__23797;
if(cljs.core.truth_(target__20638__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23797)].join(''),"\n","target__20638__auto__"].join('')));
}

(target__20638__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
