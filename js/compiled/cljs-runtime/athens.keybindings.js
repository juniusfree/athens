...
var vec__61218 = athens.keybindings.get_end_points(e.target);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61218,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61218,(1),null);
return (start === (0));
});
...
var caret_position_61418 = athens.util.get_caret_position(e.target);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"caret-position","caret-position",1352592340),caret_position_61418);
} else {
}
