...
var G__35635 = cljs.core.cons(pdb,path);
var G__35636 = posh.lib.db.get_parent_db(pdb);
path = G__35635;
pdb = G__35636;
continue;
} else {
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35606__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35606__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35606__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35606__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__35612 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35612.cljs$core$IFn$_invoke$arity$1 ? fexpr__35612.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__35612.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__35613 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35613.cljs$core$IFn$_invoke$arity$2 ? fexpr__35613.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__35613.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__35614 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35614.cljs$core$IFn$_invoke$arity$2 ? fexpr__35614.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__35614.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__35615 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35615.cljs$core$IFn$_invoke$arity$2 ? fexpr__35615.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__35615.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__35617 = db__$4;
var G__35618 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__35616 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
...
var G__35625 = (function (){var G__35627 = posh_tree;
var G__35628 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__35627,G__35628) : posh.lib.db.poshdb__GT_db.call(null,G__35627,G__35628));
})();
var G__35626 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__35624 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__35624.cljs$core$IFn$_invoke$arity$2 ? fexpr__35624.cljs$core$IFn$_invoke$arity$2(G__35625,G__35626) : fexpr__35624.call(null,G__35625,G__35626));
}
});
