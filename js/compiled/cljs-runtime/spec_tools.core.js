...
var spec_tools$core$Transformer$_options$dyn_59028 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return spec_tools$core$Transformer$_options$dyn_59028(this$);
}
});
...
if((x instanceof cljs.core.Keyword)){
var G__59104 = cljs.spec.alpha.get_spec(x);
x = G__59104;
continue;
} else {
