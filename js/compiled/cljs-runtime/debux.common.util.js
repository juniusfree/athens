...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57106_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57106_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57105_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57105_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57107_SHARP_){
return (((p1__57107_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57107_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57123,mapping){
var map__57124 = p__57123;
...
var state = map__57124__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57124__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57121_SHARP_){
if((p1__57121_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57121_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57251 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57252 = clojure.zip.next(loc);
loc = G__57252;
continue;
}
}
...
var len__4736__auto___57257 = arguments.length;
var i__4737__auto___57258 = (0);
while(true){
if((i__4737__auto___57258 < len__4736__auto___57257)){
args__4742__auto__.push((arguments[i__4737__auto___57258]));

var G__57259 = (i__4737__auto___57258 + (1));
i__4737__auto___57258 = G__57259;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57167){
var vec__57168 = p__57167;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57168,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57165){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57171_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57171_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57173_57268 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57174_57269 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57175_57270 = true;
var _STAR_print_fn_STAR__temp_val__57176_57271 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57175_57270);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57176_57271);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57174_57269);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57173_57268);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57172_SHARP_){
return debux.common.util.prepend_bars(p1__57172_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__57276 = cljs.core.next(opts__$1);
var G__57277 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57276;
acc = G__57277;
continue;
} else {
if(typeof f === 'string'){
var G__57278 = cljs.core.next(opts__$1);
var G__57279 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57278;
acc = G__57279;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57280 = cljs.core.nnext(opts__$1);
var G__57281 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57280;
acc = G__57281;
continue;
} else {
...
var G__57283 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57282;
acc = G__57283;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57191 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57191.cljs$core$IFn$_invoke$arity$1 ? fexpr__57191.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57191.call(null,f));
})())){
var G__57285 = cljs.core.next(opts__$1);
var G__57286 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57285;
acc = G__57286;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57192 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57192.cljs$core$IFn$_invoke$arity$1 ? fexpr__57192.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57192.call(null,f));
})())){
var G__57287 = cljs.core.nnext(opts__$1);
var G__57288 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57287;
acc = G__57288;
continue;
} else {
...
var G__57291 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57290;
acc = G__57291;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57193){
...
var G__57201 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57200 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57200.cljs$core$IFn$_invoke$arity$1 ? fexpr__57200.cljs$core$IFn$_invoke$arity$1(G__57201) : fexpr__57200.call(null,G__57201));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57217 = quoted_form;
var G__57218 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57217,G__57218) : debux.common.util.remove_d.call(null,G__57217,G__57218));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57219 = quoted_form;
var G__57220 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57219,G__57220) : debux.common.util.remove_d.call(null,G__57219,G__57220));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57292__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57221 = quoted_form;
var G__57222 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57221,G__57222) : debux.common.util.remove_d.call(null,G__57221,G__57222));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__57293__i < G__57293__a.length) {G__57293__a[G__57293__i] = arguments[G__57293__i + 0]; ++G__57293__i;}
  arg = new cljs.core.IndexedSeq(G__57293__a,0,null);
} 
return G__57292__delegate.call(this,arg);};
G__57292.cljs$lang$maxFixedArity = 0;
G__57292.cljs$lang$applyTo = (function (arglist__57294){
var arg = cljs.core.seq(arglist__57294);
return G__57292__delegate(arg);
});
...
var G__57296 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57296;
continue;
} else {
...
var G__57298 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57298;
continue;
} else {
