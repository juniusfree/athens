 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57104,mapping){
var map__57105 = p__57104;
...
var state = map__57105__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57105__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57105__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57105__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
var G__57204 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57208 = clojure.zip.next(loc);
loc = G__57208;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57129){
var vec__57130 = p__57129;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57130,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57123){
var G__57124 = cljs.core.first(seq57123);
var seq57123__$1 = cljs.core.next(seq57123);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57124,seq57123__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57133_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57133_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57135_57231 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57136_57232 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57137_57233 = true;
var _STAR_print_fn_STAR__temp_val__57138_57234 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57137_57233);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57138_57234);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57136_57232);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57135_57231);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57134_SHARP_){
return debux.common.util.prepend_bars(p1__57134_SHARP_,indent_level);
...
var G__57238 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57237;
acc = G__57238;
continue;
} else {
if(typeof f === 'string'){
var G__57239 = cljs.core.next(opts__$1);
var G__57240 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57239;
acc = G__57240;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__57241 = cljs.core.nnext(opts__$1);
var G__57242 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57241;
acc = G__57242;
continue;
} else {
...
var G__57244 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57243;
acc = G__57244;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57145 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57145.cljs$core$IFn$_invoke$arity$1 ? fexpr__57145.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57145.call(null,f));
})())){
var G__57245 = cljs.core.next(opts__$1);
var G__57246 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57245;
acc = G__57246;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57150 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57150.cljs$core$IFn$_invoke$arity$1 ? fexpr__57150.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57150.call(null,f));
})())){
var G__57247 = cljs.core.nnext(opts__$1);
var G__57248 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57247;
acc = G__57248;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57155){
var vec__57156 = p__57155;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57156,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57156,(1),null);
...
var G__57168 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57167 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57167.cljs$core$IFn$_invoke$arity$1 ? fexpr__57167.cljs$core$IFn$_invoke$arity$1(G__57168) : fexpr__57167.call(null,G__57168));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57184 = quoted_form;
var G__57185 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57184,G__57185) : debux.common.util.remove_d.call(null,G__57184,G__57185));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57190 = quoted_form;
var G__57191 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57190,G__57191) : debux.common.util.remove_d.call(null,G__57190,G__57191));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57192 = quoted_form;
var G__57193 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57192,G__57193) : debux.common.util.remove_d.call(null,G__57192,G__57193));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__57252__i < G__57252__a.length) {G__57252__a[G__57252__i] = arguments[G__57252__i + 0]; ++G__57252__i;}
  arg = new cljs.core.IndexedSeq(G__57252__a,0,null);
} 
