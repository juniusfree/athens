...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57216_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57216_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57215_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57215_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57217_SHARP_){
return (((p1__57217_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57217_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57232,mapping){
var map__57233 = p__57232;
...
var state = map__57233__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57233__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57233__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57233__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57230_SHARP_){
if((p1__57230_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57230_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57294 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57303 = (i__4737__auto___57299 + (1));
i__4737__auto___57299 = G__57303;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57244){
var vec__57246 = p__57244;
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57240){
var G__57241 = cljs.core.first(seq57240);
var seq57240__$1 = cljs.core.next(seq57240);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57241,seq57240__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57254_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57254_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57263_57305 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57264_57306 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57265_57307 = true;
var _STAR_print_fn_STAR__temp_val__57266_57308 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57265_57307);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57266_57308);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57264_57306);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57263_57305);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57262_SHARP_){
return debux.common.util.prepend_bars(p1__57262_SHARP_,indent_level);
...
if(cljs.core.truth_((function (){var fexpr__57276 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57277 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57278){
var vec__57279 = p__57278;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57279,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57279,(1),null);
...
return (function() { 
var G__57324__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57291 = quoted_form;
var G__57292 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57291,G__57292) : debux.common.util.remove_d.call(null,G__57291,G__57292));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57324 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57325__i = 0, G__57325__a = new Array(arguments.length -  0);
while (G__57325__i < G__57325__a.length) {G__57325__a[G__57325__i] = arguments[G__57325__i + 0]; ++G__57325__i;}
  arg = new cljs.core.IndexedSeq(G__57325__a,0,null);
} 
return G__57324__delegate.call(this,arg);};
G__57324.cljs$lang$maxFixedArity = 0;
G__57324.cljs$lang$applyTo = (function (arglist__57326){
var arg = cljs.core.seq(arglist__57326);
return G__57324__delegate(arg);
});
G__57324.cljs$core$IFn$_invoke$arity$variadic = G__57324__delegate;
return G__57324;
})()
;
});
...
var G__57327 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57327;
continue;
} else {
...
var G__57328 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57328;
continue;
} else {
var G__57329 = clojure.zip.next(loc);
loc = G__57329;
continue;
