...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57119_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57119_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57118_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57118_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57120_SHARP_){
return (((p1__57120_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57120_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57135,mapping){
var map__57136 = p__57135;
var map__57136__$1 = (((((!((map__57136 == null))))?(((((map__57136.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57136.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57136):map__57136);
var state = map__57136__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57136__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57136__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57136__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57129_SHARP_){
if((p1__57129_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57129_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57261 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57262 = clojure.zip.next(loc);
loc = G__57262;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57179){
var vec__57180 = p__57179;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57180,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57174){
var G__57175 = cljs.core.first(seq57174);
var seq57174__$1 = cljs.core.next(seq57174);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57175,seq57174__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57183_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57183_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57191_57274 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57192_57275 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57193_57276 = true;
var _STAR_print_fn_STAR__temp_val__57194_57277 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57193_57276);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57194_57277);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57192_57275);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57191_57274);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57184_SHARP_){
return debux.common.util.prepend_bars(p1__57184_SHARP_,indent_level);
...
var G__57217 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57216 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57216.cljs$core$IFn$_invoke$arity$1 ? fexpr__57216.cljs$core$IFn$_invoke$arity$1(G__57217) : fexpr__57216.call(null,G__57217));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57226 = quoted_form;
var G__57227 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57226,G__57227) : debux.common.util.remove_d.call(null,G__57226,G__57227));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57242 = quoted_form;
var G__57243 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57242,G__57243) : debux.common.util.remove_d.call(null,G__57242,G__57243));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
G__57294.cljs$lang$applyTo = (function (arglist__57298){
...
var G__57305 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57305;
continue;
} else {
...
var G__57306 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57306;
continue;
} else {
var G__57311 = clojure.zip.next(loc);
loc = G__57311;
continue;
