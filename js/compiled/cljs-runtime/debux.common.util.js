...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57217_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57217_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57216_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57216_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57218_SHARP_){
return (((p1__57218_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57218_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57223,mapping){
var map__57224 = p__57223;
var map__57224__$1 = (((((!((map__57224 == null))))?(((((map__57224.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57224.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57224):map__57224);
var state = map__57224__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57224__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57224__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57224__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57221_SHARP_){
if((p1__57221_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57221_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57297 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57298 = clojure.zip.next(loc);
loc = G__57298;
continue;
}
}
...
var len__4736__auto___57301 = arguments.length;
var i__4737__auto___57302 = (0);
while(true){
if((i__4737__auto___57302 < len__4736__auto___57301)){
args__4742__auto__.push((arguments[i__4737__auto___57302]));

var G__57303 = (i__4737__auto___57302 + (1));
i__4737__auto___57302 = G__57303;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57245){
var vec__57246 = p__57245;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57246,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57243){
var G__57244 = cljs.core.first(seq57243);
var seq57243__$1 = cljs.core.next(seq57243);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57244,seq57243__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57249_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57249_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57251_57304 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57252_57305 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57253_57306 = true;
var _STAR_print_fn_STAR__temp_val__57254_57307 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57253_57306);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57254_57307);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57252_57305);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57251_57304);
}
...
var G__57309 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__57308;
acc = G__57309;
continue;
} else {
...
var G__57311 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__57310;
acc = G__57311;
continue;
} else {
...
var G__57313 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__57312;
acc = G__57313;
continue;
} else {
...
var G__57315 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__57314;
acc = G__57315;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57272 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__57272.cljs$core$IFn$_invoke$arity$1 ? fexpr__57272.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57272.call(null,f));
})())){
var G__57316 = cljs.core.next(opts__$1);
var G__57317 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__57316;
acc = G__57317;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__57273 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__57273.cljs$core$IFn$_invoke$arity$1 ? fexpr__57273.cljs$core$IFn$_invoke$arity$1(f) : fexpr__57273.call(null,f));
})())){
var G__57318 = cljs.core.nnext(opts__$1);
var G__57319 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57318;
acc = G__57319;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57320 = cljs.core.next(opts__$1);
var G__57321 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57320;
acc = G__57321;
continue;
} else {
