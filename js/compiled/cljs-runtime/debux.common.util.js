...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57121_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__57121_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57120_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57120_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57122_SHARP_){
return (((p1__57122_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__57122_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__57129,mapping){
var map__57130 = p__57129;
...
var state = map__57130__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57130__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57130__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57130__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__57123_SHARP_){
if((p1__57123_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__57123_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__57255 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__57256 = clojure.zip.next(loc);
loc = G__57256;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__57169){
var vec__57170 = p__57169;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57170,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq57167){
var G__57168 = cljs.core.first(seq57167);
var seq57167__$1 = cljs.core.next(seq57167);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57168,seq57167__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57173_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__57173_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__57187_57276 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57188_57277 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57189_57278 = true;
var _STAR_print_fn_STAR__temp_val__57190_57279 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57189_57278);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57190_57279);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57188_57277);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57187_57276);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__57180_SHARP_){
return debux.common.util.prepend_bars(p1__57180_SHARP_,indent_level);
...
var G__57291 = cljs.core.nnext(opts__$1);
var G__57292 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__57291;
acc = G__57292;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__57294 = cljs.core.next(opts__$1);
var G__57295 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__57294;
acc = G__57295;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__57212){
var vec__57213 = p__57212;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57213,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57213,(1),null);
...
var G__57219 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__57218 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__57218.cljs$core$IFn$_invoke$arity$1 ? fexpr__57218.cljs$core$IFn$_invoke$arity$1(G__57219) : fexpr__57218.call(null,G__57219));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57223 = quoted_form;
var G__57224 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57223,G__57224) : debux.common.util.remove_d.call(null,G__57223,G__57224));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__57296__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__57232 = quoted_form;
var G__57233 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__57232,G__57233) : debux.common.util.remove_d.call(null,G__57232,G__57233));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__57296 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__57297__i = 0, G__57297__a = new Array(arguments.length -  0);
while (G__57297__i < G__57297__a.length) {G__57297__a[G__57297__i] = arguments[G__57297__i + 0]; ++G__57297__i;}
  arg = new cljs.core.IndexedSeq(G__57297__a,0,null);
} 
return G__57296__delegate.call(this,arg);};
G__57296.cljs$lang$maxFixedArity = 0;
G__57296.cljs$lang$applyTo = (function (arglist__57298){
var arg = cljs.core.seq(arglist__57298);
return G__57296__delegate(arg);
});
G__57296.cljs$core$IFn$_invoke$arity$variadic = G__57296__delegate;
return G__57296;
})()
;
});
...
var G__57299 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__57299;
continue;
} else {
...
var G__57300 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__57300;
continue;
} else {
