...
var G__46598 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__46599 = cljs.core.next(xs__$1);
acc = G__46598;
xs__$1 = G__46599;
continue;
...
var map__46566 = cljs.core.deref(state);
var map__46566__$1 = (((((!((map__46566 == null))))?(((((map__46566.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46566.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46566):map__46566);
var local = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46566__$1,new cljs.core.Keyword("string","local","string/local",-578009907));
var previous = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46566__$1,new cljs.core.Keyword("string","previous","string/previous",1734905219));
